...
public class HttpConfiguration {
	 ...
	 */
	private static final String DEFAULT_ENDPOINT = "https://api.fire.com/business/v1";
	...
	/** The URL of the Fire Business service. */
	private String endpoint;

	/** The timeout, in milli-seconds, for sending a request to Fire. */
	private int timeout;
	...
	/**
	 * The timeout for a request to Fire.
	 * 
	 * @return the timeout
	 */
	...
	/**
	 * Set the timeout, in milli-seconds, for sending a request to Fire.
	 * 
